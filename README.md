...
Choose legacy code (https://github.com/emilybache/GildedRose-Refactoring-Kata) in the language of your choice. The aim is to practice good design in the language of your choice. Refactor the code in such a way that adding the new "conjured" functionality is easy.

Technology Used
---------
* Javascript with ES6 for the first time
* Jasmine test suite (with Chicago TDD)
